...
<head>
    ...
    <script src="https://kit.fontawesome.com/509dd4e93e.js" crossorigin="anonymous"></script>
    ...
    <script>
        ...
        function removerTarefa(id){
            location.href = "todas_tarefas.php?acao=removerTarefa&id="
        }
        function editarTarefa(id, txt_tarefa) {
            //criação do from de edição
            let form = document.createElement('form');
            form.action = 'todas_tarefas.php?pagina=inde&acao=atualizarTarefa';
            form.method = 'post';
            form.className = 'row';
                                ...
                                <div class="row mb-3 d-flex align-items-center">
                                    ...
                                    <div class="col-sm-3 mt-2 d-flex justify-content-between">
                                        ...
                                        <?php if ($tarefa->status == 'pendente') { ?>
                                            ...
                                            <i class="fa-regular fa-circle-check fa-lg text-succsess" onclick="marcarRealizada(<?= $tarefa->id ?>)"></i> <?php } ?>
